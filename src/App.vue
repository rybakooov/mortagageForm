<template>
  <form class="mort" id="app">
    <h1 class="mort__title">Единая анкета</h1>
    <Borrowers/>
    <Condition/>
    <PersonalInfo/>
    <Job/>
...
import Condition from './components/Сonditions/';
